...
export { COMPILATION_RESULT_SCHEMA, COMPILE_FAILURE_SCHEMA, CONTEXT_CANDIDATE_SCHEMA, CONTEXT_REQUEST_SCHEMA, DECISION_TRACE_SCHEMA, DECISION_TRACE_SCHEMA_V1, COMPILATION_RESULT_SCHEMA_V1, FAILURE_REASONS, REQUIREMENT_CLASSES, TRACE_DECISIONS, candidateFromJSON, candidateToJSON, failureFromJSON, failureToJSON, parseFailureReason, parseRequirementClass, parseTraceDecision, requestFromJSON, requestToJSON, resultFromJSON, resultToJSON, resultToV1JSON, traceEntryFromJSON, traceEntryToJSON, traceFromJSON, traceToJSON, traceToV1JSON, type CompilationResult, type CompileFailure, type ContextCandidate, type ContextRequest, type DecisionTrace, type FailureReason, type RequirementClass, type TraceDecision, type TraceEntry, } from "./domain.ts";
